	...
	public void onCreate(Bundle savedInstanceState){
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> l, View view, int position,	long id) {
				...
				if(!UpdateUtils.FindSimilarWidget(context,cur,mAppWidgetId,UpdateUtils.SMALL)){
					UpdateUtils.updateWidgetLocal(context,cur,mAppWidgetId,UpdateUtils.SMALL);
				}
	...
	public boolean onContextItemSelected(MenuItem item){
		...
		switch (item.getItemId()){
			...
			case CONTEXT_DELETE:
				...
				getContentResolver().delete(BaseHelper.uri, ColumnNames.PLANET_NAME+"=?",
